...
class Api {
    ...
    getFixedTasks() {
      return axios.get(`${this._baseURL}/tasks/fixed`, { headers: this._getAuthorizationHeaders() })
      .then((res) => {
          return res.data;
        })
        .catch((error) => {
      ...
      getIdeas() {
      return axios.get(`${this._baseURL}/tasks/ideas`, { headers: this._getAuthorizationHeaders() })
      .then((res) => {
          return res.data;
        })
        .catch((error) => {
